...
public class ModBlocks {
    ...
    /**
    public static Block WHITE_BEDROLL = registerWithoutItem("white_bedroll", createBedrollBlock(DyeColor.WHITE));
    public static Block ORANGE_BEDROLL = registerWithoutItem("orange_bedroll", createBedrollBlock(DyeColor.ORANGE));
    public static Block MAGENTA_BEDROLL = registerWithoutItem("magenta_bedroll", createBedrollBlock(DyeColor.MAGENTA));
    public static Block LIGHT_BLUE_BEDROLL = registerWithoutItem("light_blue_bedroll", createBedrollBlock(DyeColor.LIGHT_BLUE));
    public static Block YELLOW_BEDROLL = registerWithoutItem("yellow_bedroll", createBedrollBlock(DyeColor.YELLOW));
    public static Block LIME_BEDROLL = registerWithoutItem("lime_bedroll", createBedrollBlock(DyeColor.LIME));
    public static Block PINK_BEDROLL = registerWithoutItem("pink_bedroll", createBedrollBlock(DyeColor.PINK));
    public static Block GRAY_BEDROLL = registerWithoutItem("gray_bedroll", createBedrollBlock(DyeColor.GRAY));
    public static Block LIGHT_GRAY_BEDROLL = registerWithoutItem("light_gray_bedroll", createBedrollBlock(DyeColor.LIGHT_GRAY));
    public static Block CYAN_BEDROLL = registerWithoutItem("cyan_bedroll", createBedrollBlock(DyeColor.CYAN));
    public static Block PURPLE_BEDROLL = registerWithoutItem("purple_bedroll", createBedrollBlock(DyeColor.PURPLE));
    public static Block BLUE_BEDROLL = registerWithoutItem("blue_bedroll", createBedrollBlock(DyeColor.BLUE));
    public static Block BROWN_BEDROLL = registerWithoutItem("brown_bedroll", createBedrollBlock(DyeColor.BROWN));
    public static Block GREEN_BEDROLL = registerWithoutItem("green_bedroll", createBedrollBlock(DyeColor.GREEN));
    public static Block RED_BEDROLL = registerWithoutItem("red_bedroll", createBedrollBlock(DyeColor.RED));
    public static Block BLACK_BEDROLL = registerWithoutItem("black_bedroll", createBedrollBlock(DyeColor.BLACK));
     **/
